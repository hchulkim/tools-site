...
This page contains an outline of the topics, contents, and works I did for Spatial economics self-study. 
...
library(tidyverse)
gs4_deauth()
d <- read_sheet("https://docs.google.com/spreadsheets/d/16al0i5qXkKP0wKX86-TRgB0zpJRbwZywreXhBo--wSk/edit?usp=sharing", sheet = "spatial")
```
